...
Educraft is a modern SaaS application designed to revolutionize online learning through AI-powered voice tutoring. Built for students and educators, Educraft enables interactive, real-time learning experiences with customizable AI companions. Users can create their own AI tutors, choose subjects and topics, and engage in natural voice conversations to enhance understanding and retention. With secure authentication, session history, and a scalable tech stack, Educraft makes high-quality, personalized education accessible to everyone, anytime, on any device.
...
```bash
git clone https://github.com/ShreyashkumarDube/educraft.git
cd saas-app
```
